...
const VALID_ELEMENTS = [
  ...
  "label", "a", "strong", "em", "i", "b", "small", "mark",
  "del", "ins", "sub", "sup", "q", "blockquote", "cite",
  "dfn", "abbr", "time", "code", "var", "samp", "kbd",
  "pre", "address", "figcaption", "li", "dt", "dd", "th", "td"
] as const;

const VALID_TEXT_STYLES = [
  "body", "body-bold", "title", "title-light", "caption", "caption-bold",
  "heading-1", "heading-2", "heading-3", "heading-4", "heading-5", "heading-6", "heading-6-allcaps"
] as const;

const VALID_COLORS = [
  "background-primary", "background-raised", "background-recessed",
  "foreground-primary", "foreground-secondary", "foreground-disabled", "foreground-tint",
  "blue-primary", "green-primary", "yellow-primary", "orange-primary", "red-primary",
  "gold-primary", "gold-secondary",
  "blue-tint-75", "green-tint-75", "yellow-tint-75", "orange-tint-75", "red-tint-75",
  "blue-tint-25", "green-tint-25", "yellow-tint-25", "orange-tint-25", "red-tint-25",
  "blue-tint-08", "green-tint-08", "yellow-tint-08", "orange-tint-08", "red-tint-08",
  "heb-red-primary", "heb-red-dark", "heb-red-light"
] as const;
...
class FvrText extends HTMLElement {
  ...
  connectedCallback(): void {
    ...
    this._textStyle = FvrText.getValidTextStyle(this.getAttribute("text-style"));
  ...
  private static getValidElement(value: string | null): TextContainingElement {
    return FvrText.validElements.has(value as TextContainingElement) ? (value as TextContainingElement) : "p";
  }

  private static getValidTextStyle(value: string | null): TextStyle {
    return FvrText.validTextStyles.has(value as TextStyle) ? (value as TextStyle) : "body";
  }

  private static getValidColor(value: string | null): Color {
    return FvrText.validColors.has(value as Color) ? (value as Color) : "foreground-primary";
  }
...
const registerFvrText = (customElementRegistry: CustomElementRegistry = window.customElements): void => {
